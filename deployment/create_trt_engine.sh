...
ONNX="bocc-r50-cbgs_depth_16f_16x4_20e_trt.onnx"
TRT_PATH="/usr/src/tensorrt/"
TRT_PLUGIN_PATH="TensorRT/lib/libtensorrt.so"
TRT_ENGINE_PATH="fbocc-r50-cbgs_depth_16f_16x4_20e_trt.engine"
FP16=false
...
TRTEXEC_CMD="${TRT_PATH}/bin/trtexec --useCudaGraph"
if [ "$FP16" = true ]; then
    TRTEXEC_CMD+=" --fp16"
fi
...
MIN_SHAPES="--minShapes=ranks_bev:200000,ranks_depth:200000,ranks_feat:200000,interval_starts:50000,interval_lengths:50000,indexes:1x6x1000,queries_rebatch:1x6x1000x80,reference_points_rebatch:1x6x1000x4x2,bev_query_depth_rebatch:1x6x1000x4x1"

MAX_SHAPES="--maxShapes=ranks_bev:210000,ranks_depth:210000,ranks_feat:210000,interval_starts:55000,interval_lengths:55000,indexes:1x6x4000,queries_rebatch:1x6x4000x80,reference_points_rebatch:1x6x4000x4x2,bev_query_depth_rebatch:1x6x4000x4x1"
